...
function loadPostsComments(action) {
  var result;
  return regeneratorRuntime.wrap(
    function loadPostsComments$(_context2) {
      while (1) {
...
function loadGallary(action) {
  var result;
  return regeneratorRuntime.wrap(
    function loadGallary$(_context3) {
      while (1) {
...
function uploadImages(action) {
  var result;
  return regeneratorRuntime.wrap(
    function uploadImages$(_context4) {
      while (1) {
...
function addComment(action) {
  var result;
  return regeneratorRuntime.wrap(
    function addComment$(_context10) {
      while (1) {
...
function removeComment(action) {
  var result;
  return regeneratorRuntime.wrap(
    function removeComment$(_context11) {
      while (1) {
...
function updateComment(action) {
  var result;
  return regeneratorRuntime.wrap(
    function updateComment$(_context12) {
      while (1) {
...
function likeListComment(action) {
  var result;
  return regeneratorRuntime.wrap(
    function likeListComment$(_context13) {
      while (1) {
...
function loadPostDetail(action) {
  var result;
  return regeneratorRuntime.wrap(
    function loadPostDetail$(_context14) {
      while (1) {
      ...
      switch ((_context29.prev = _context29.next)) {
        case 0:
          ...
          return (0, _effects.all)([
            (0, _effects.fork)(watchLoadPosts),
            (0, _effects.fork)(watchLoadGallary),
            (0, _effects.fork)(watchUploadImages),
            (0, _effects.fork)(watchAddPost),
            (0, _effects.fork)(watchRemovePost),
            (0, _effects.fork)(watchUpdatePost),
            (0, _effects.fork)(watchLikePost),
            (0, _effects.fork)(watchUnlikePost),
            (0, _effects.fork)(watchAddComment),
            (0, _effects.fork)(watchRemoveComment),
            (0, _effects.fork)(watchUpdateComment),
            (0, _effects.fork)(watchLoadPostsComments),
            (0, _effects.fork)(watchLikeListComments),
