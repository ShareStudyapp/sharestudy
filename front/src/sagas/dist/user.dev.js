...
function uploadProfileImages(action) {
  var result;
  return regeneratorRuntime.wrap(
    function uploadProfileImages$(_context5) {
      while (1) {
...
function followCancle(action) {
  var result;
  return regeneratorRuntime.wrap(
    function followCancle$(_context7) {
      while (1) {
...
function followerList(action) {
  var result;
  return regeneratorRuntime.wrap(
    function followerList$(_context8) {
      while (1) {
...
function followingList(action) {
  var result;
  return regeneratorRuntime.wrap(
    function followingList$(_context9) {
      while (1) {
...
function otherUserInfo(action) {
  var result;
  return regeneratorRuntime.wrap(
    function otherUserInfo$(_context10) {
      while (1) {
...
function userInfoUpdate(action) {
  var result;
  return regeneratorRuntime.wrap(
    function userInfoUpdate$(_context11) {
      while (1) {
      ...
      switch ((_context23.prev = _context23.next)) {
        case 0:
          ...
          return (0, _effects.all)([
            (0, _effects.fork)(watchSignUp),
            (0, _effects.fork)(watchLogIn),
            (0, _effects.fork)(watchUserInfo),
            (0, _effects.fork)(watchLogOut),
            (0, _effects.fork)(watchProfileUploadImages),
            (0, _effects.fork)(watchFollow),
            (0, _effects.fork)(watchFollowCancle),
            (0, _effects.fork)(watchFollowerList),
            (0, _effects.fork)(watchFollowingList),
            (0, _effects.fork)(watchOtherUserInfo),
            (0, _effects.fork)(watchUserInfoUpdate)
          ]);
